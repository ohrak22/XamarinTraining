...
namespace OpenGL
{
	class GLView_DrawTriangle : AndroidGameView
	{
		public GLView_DrawTriangle(Context context) : base(context)
		{
		...
		protected override void OnRenderFrame(FrameEventArgs e)
		{
			...
			GL.VertexPointer(2, All.Float, 0, triangle_vertices);
			GL.EnableClientState(All.VertexArray);
			GL.ColorPointer(4, All.UnsignedByte, 0, triangle_colors);
			GL.EnableClientState(All.ColorArray);

			GL.DrawArrays(All.TriangleStrip, 0, 3);
